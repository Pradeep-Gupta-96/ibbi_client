...
const Highlights = () => {
    ...
    const handleSubmit = async (event) => {
        try {
            ...
            const API = "http://localhost:4000/highlights/inserthighlights";
    ...
    const handleForDelete = async (id) => {
        try {
            const API = `http://localhost:4000/highlights/deletehighlightsById/${id}`;
    ...
    useEffect(() => {
        ...
        async function fetchTodos() {
            try {
                ...
                setTodos(data.highlights.reverse()); // Assuming the response contains an array of todos
            } catch (error) {
                    ...
                    <div className='blog-sec highlights-sec padding-50'>
                        <div className="bound">
                            {localStorage.getItem("token") ? <div className="add-post-sec">
                                ...
                                <h3><span>Add new Highlights</span> <Button onClick={logout}>Logout</Button></h3>
                                <Box component="form"
                                    noValidate
                                            ...
                                            <div className="content-box">
                                                ...
                                                <div className='more-text subscribe-btn'>
                                                    ...
                                                    {localStorage.getItem("token") && (
                                                        <>
                                                            <Link to={`/editHighlights/${item.id}`} className='blue-btn'>
                                                                <EditIcon />
                                                            </Link>
